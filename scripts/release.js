...
const PACKAGES = [
  ...
  'packages/ftp/package.json',
  'packages/smb/package.json',
  'packages/tts/package.json',
  'packages/ui/package.json',
  'packages/webdav/package.json',
];
